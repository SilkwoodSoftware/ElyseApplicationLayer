...
@Component({
  selector: 'app-read-roles-by-user',
  templateUrl: './read-roles-by-user.component.html',
  styleUrls: ['./read-roles-by-user.component.scss']
})
export class ReadRolesByUserComponent {
  ...
  constructor(
    public dialogRef: MatDialogRef<ReadRolesByUserComponent>,
