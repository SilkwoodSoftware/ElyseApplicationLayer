...
export class ConfirmationDialogComponent implements AfterViewInit {
  ...
  ngAfterViewInit() {
    // Let the shared stylesheets handle all styling for consistency
    // with LoadFilesAndLinkComponent
  }
  constructor(
  ...
  onYesClick(): void {
    const inputValue = this.data.inputField ? this.inputField?.nativeElement.value : undefined;
    this.dialogRef.close(this.data.inputField ? { confirmed: true, input: inputValue } : true);
  }
