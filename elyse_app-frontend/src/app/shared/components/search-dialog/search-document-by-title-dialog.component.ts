...
@Component({
  selector: 'app-search-document-by-title-dialog',
  templateUrl: 'search-document-by-title-dialog.component.html',
  styleUrls: ['../../stylesheets/dialogs.scss'],
  standalone: true,
  imports: [CommonModule, ReactiveFormsModule]
})
export class SearchDocumentByTitleDialogComponent {
  ...
  constructor(
    ...
    private dialogRef: MatDialogRef<SearchDocumentByTitleDialogComponent>,
  ...
  onSubmit() {
    if (this.searchForm.valid) {
       ...
       this.router.navigate(['/document/docs-by-text-field'], { 
         queryParams: { 
          likeString: encodeURIComponent(title),
           doctextnameid: null,
           filterGroupId : null,
           formId: null    
        }});   
