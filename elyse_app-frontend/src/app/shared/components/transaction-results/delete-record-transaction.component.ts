 ...
 */
 ...
 @Component({
   selector: 'app-delete-record-transaction',
   templateUrl: './delete-record-transaction.component.html',
   styleUrls: ['./delete-record-transaction.component.scss']
 })
 export class DeleteRecordTransactionComponent {
   ...
   constructor(
     public dialogRef: MatDialogRef<DeleteRecordTransactionComponent>,
