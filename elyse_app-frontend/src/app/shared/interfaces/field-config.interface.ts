...
export interface FieldConfig {
  ...
  // Lookup specific properties (progressive discovery via form field menu)
  isLookup?: boolean;
  lookupMenuId?: string;  // References FormFieldMenuID in form-field-menus.csv
  lookupIdAlias?: string;  // Column name alias for the ID value in table results
  lookupNameAlias?: string;  // Column name alias for the display value in table results
}
