...
export const DOC_FILE_FORM_FIELD_ROUTING_SCHEMA: CsvSchema = {
  ...
  columns: [
    ...
    { name: 'Data Type', required: true, allowEmpty: false, enumValues: ['Date', 'Integer', 'List', 'Lookup', 'MultiSelectList', 'Real', 'Text', 'Value'] },
    ...
    { name: 'Lookup Menu ID', required: true },
    { name: 'Lookup ID Alias', required: true },
    { name: 'Lookup Name Alias', required: true },
  ],
};
