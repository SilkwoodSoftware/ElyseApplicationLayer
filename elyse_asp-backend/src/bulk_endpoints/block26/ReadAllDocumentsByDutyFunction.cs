...
[Route("api/document/duty-function")]
[ApiController]
public class ReadAllDocumentsByDutyFunction : BaseStoredProcedureController
{
    public ReadAllDocumentsByDutyFunction(StoredProcedureService storedProcedureService, ILogger<ReadAllDocumentsByDutyFunction> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? functionId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all documents by duty function",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_docs_by_dty_funct", parameters);
            },
            result =>
            {
