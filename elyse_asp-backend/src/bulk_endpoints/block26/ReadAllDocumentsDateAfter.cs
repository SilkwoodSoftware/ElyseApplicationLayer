...
[Route("api/document/date/after")]
[ApiController]
public class ReadAllDocumentsDateAfter : BaseStoredProcedureController
{
    public ReadAllDocumentsDateAfter(StoredProcedureService storedProcedureService, ILogger<ReadAllDocumentsDateAfter> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? docDateNameId = null, [FromQuery] string dateValue = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all documents date after",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_docs_date_after", parameters);
            },
            result =>
            {
