...
[Route("api/document/date/between")]
[ApiController]
public class ReadAllDocumentsDateBetween : BaseStoredProcedureController
{
    public ReadAllDocumentsDateBetween(StoredProcedureService storedProcedureService, ILogger<ReadAllDocumentsDateBetween> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] long? docDateNameId = null, [FromQuery] string earlierDate = null, [FromQuery] string laterDate = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all documents date between",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_docs_date_between", parameters);
            },
            result =>
            {
