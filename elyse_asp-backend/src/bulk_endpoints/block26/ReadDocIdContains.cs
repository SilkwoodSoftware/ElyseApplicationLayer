...
[Route("api/document/id-contains")]
[ApiController]
public class ReadDocIdContains : BaseStoredProcedureController
{
    public ReadDocIdContains(StoredProcedureService storedProcedureService, ILogger<ReadDocIdContains> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] string containsString = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading documents by ID contains",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_doc_id_contains", parameters);
            },
            result =>
            {
