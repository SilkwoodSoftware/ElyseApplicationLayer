...
[Route("api/document/real/between")]
[ApiController]
public class ReadAllDocumentsRealNumberBetween : BaseStoredProcedureController
{
    public ReadAllDocumentsRealNumberBetween(StoredProcedureService storedProcedureService, ILogger<ReadAllDocumentsRealNumberBetween> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? docRealNameId = null, [FromQuery] float? lowerRealValue = null, [FromQuery] float? upperRealValue = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all documents real number between",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_docs_real_between", parameters);
            },
            result =>
            {
