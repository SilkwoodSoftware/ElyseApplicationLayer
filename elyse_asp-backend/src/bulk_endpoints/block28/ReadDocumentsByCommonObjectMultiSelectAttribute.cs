...
// Lists all the document and associated file records for a given common object multi-select attribute.
[Route("api/documents/common-object/multi-select")]
[ApiController]
public class ReadDocumentsByCommonObjectMultiSelectAttribute : BaseStoredProcedureController
{
    public ReadDocumentsByCommonObjectMultiSelectAttribute(StoredProcedureService storedProcedureService, ILogger<ReadDocumentsByCommonObjectMultiSelectAttribute> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? commonObjectListId = null, [FromQuery] long? commonObjectId = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading documents by common object multi-select attribute",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_docs_by_co_ms_attr", parameters);
            },
            result =>
            {
