...
// Selects metadata for documents linked to a given function list.
[Route("api/documents/function-list")]
[ApiController]
public class ReadAllDocumentsByFunctionList : BaseStoredProcedureController
{
    public ReadAllDocumentsByFunctionList(StoredProcedureService storedProcedureService, ILogger<ReadAllDocumentsByFunctionList> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? functionListId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all documents by function list",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_docs_by_funct_lst", parameters);
            },
            result =>
            {
