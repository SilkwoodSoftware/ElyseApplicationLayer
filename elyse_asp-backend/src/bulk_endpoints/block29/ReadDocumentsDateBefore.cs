...
[Route("api/documents/date/before")]
[ApiController]
public class ReadDocumentsDateBefore : BaseStoredProcedureController
{
    public ReadDocumentsDateBefore(StoredProcedureService storedProcedureService, ILogger<ReadDocumentsDateBefore> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? docDateNameId = null, [FromQuery] string dateValue = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            ...
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_docs_date_before", parameters);
            },
            result =>
            {
