...
[Route("api/documents/date/equals")]
[ApiController]
public class ReadDocumentsDateEquals : BaseStoredProcedureController
{
    public ReadDocumentsDateEquals(StoredProcedureService storedProcedureService, ILogger<ReadDocumentsDateEquals> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? docDateNameId = null, [FromQuery] string dateValue = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            ...
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_docs_date_equals", parameters);
            },
            result =>
            {
