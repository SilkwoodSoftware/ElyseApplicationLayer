...
[Route("api/documents/people-list")]
[ApiController]
public class ReadDocumentsByPeopleList : BaseStoredProcedureController
{
    public ReadDocumentsByPeopleList(StoredProcedureService storedProcedureService, ILogger<ReadDocumentsByPeopleList> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] long? peopleListId = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading documents by people list",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_docs_by_people_list", parameters);
            },
            result =>
            {
