...
[Route("api/file/common-object/multi-select/attribute")]
[ApiController]
public class ReadFilesByCommonObjectMultiSelectAttribute : BaseStoredProcedureController
{
    public ReadFilesByCommonObjectMultiSelectAttribute(StoredProcedureService storedProcedureService, ILogger<ReadFilesByCommonObjectMultiSelectAttribute> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? commonObjectListId = null, [FromQuery] long? commonObjectId = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading files by common object multi-select attribute",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_by_co_ms_attr", parameters);
            },
            result =>
            {
