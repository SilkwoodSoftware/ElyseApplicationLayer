...
[Route("api/file/date/after")]
[ApiController]
public class ReadAllFilesByDateAfter : BaseStoredProcedureController
{
    public ReadAllFilesByDateAfter(StoredProcedureService storedProcedureService, ILogger<ReadAllFilesByDateAfter> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? fileDateNameId = null, [FromQuery] string dateValue = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all files by date after",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_files_date_after", parameters);
            },
            result =>
            {
