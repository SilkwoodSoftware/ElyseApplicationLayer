...
// Returns metadata for files where a date record equals a given date.
// No filter group is applied.
[Route("api/file/date/equals")]
[ApiController]
public class ReadAllFilesDateEquals : BaseStoredProcedureController
{
    public ReadAllFilesDateEquals(StoredProcedureService storedProcedureService, ILogger<ReadAllFilesDateEquals> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? fileDateNameId = null, [FromQuery] string dateValue = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            ...
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_files_date_equals", parameters);
            },
            result =>
            {
