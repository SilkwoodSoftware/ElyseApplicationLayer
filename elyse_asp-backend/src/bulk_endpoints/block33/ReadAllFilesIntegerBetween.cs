...
[Route("api/file/integer/between")]
[ApiController]
public class ReadAllFilesIntegerBetween : BaseStoredProcedureController
{
    public ReadAllFilesIntegerBetween(StoredProcedureService storedProcedureService, ILogger<ReadAllFilesIntegerBetween> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] long? fileIntNameId = null, [FromQuery] long? lowerIntValue = null, [FromQuery] long? upperIntValue = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all files integer between",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_files_int_between", parameters);
            },
            result =>
            {
