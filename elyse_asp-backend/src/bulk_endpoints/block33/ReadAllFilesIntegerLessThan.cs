...
[Route("api/file/integer/less-than")]
[ApiController]
public class ReadAllFilesIntegerLessThan : BaseStoredProcedureController
{
    public ReadAllFilesIntegerLessThan(StoredProcedureService storedProcedureService, ILogger<ReadAllFilesIntegerLessThan> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? fileIntNameId = null, [FromQuery] long? integerValue = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all files integer less than",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_files_int_less_than", parameters);
            },
            result =>
            {
