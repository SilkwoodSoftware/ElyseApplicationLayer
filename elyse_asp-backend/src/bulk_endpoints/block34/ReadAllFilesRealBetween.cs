...
[Route("api/file/real/between")]
[ApiController]
public class ReadAllFilesRealBetween : BaseStoredProcedureController
{
    public ReadAllFilesRealBetween(StoredProcedureService storedProcedureService, ILogger<ReadAllFilesRealBetween> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] long? fileRealNumberFieldNameId = null, [FromQuery] float? lowerRealValue = null, [FromQuery] float? upperRealValue = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all files real between",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_files_real_between", parameters);
            },
            result =>
            {
