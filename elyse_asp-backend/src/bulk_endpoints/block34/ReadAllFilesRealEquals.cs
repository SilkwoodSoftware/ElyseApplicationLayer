...
[Route("api/file/real/equals")]
[ApiController]
public class ReadAllFilesRealEquals : BaseStoredProcedureController
{
    public ReadAllFilesRealEquals(StoredProcedureService storedProcedureService, ILogger<ReadAllFilesRealEquals> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? fileRealNumberFieldNameId = null, [FromQuery] float? realNumberValue = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            ...
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_files_real_equals", parameters);
            },
            result =>
            {
