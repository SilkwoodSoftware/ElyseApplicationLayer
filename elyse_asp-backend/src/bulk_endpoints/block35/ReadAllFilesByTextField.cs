...
[Route("api/file/text-field")]
[ApiController]
public class ReadAllFilesByTextField : BaseStoredProcedureController
{
    public ReadAllFilesByTextField(StoredProcedureService storedProcedureService, ILogger<ReadAllFilesByTextField> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] long? fileTextNameId = null, [FromQuery] string likeString = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading all files by text field",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_all_files_by_txt_field", parameters);
            },
            result =>
            {
