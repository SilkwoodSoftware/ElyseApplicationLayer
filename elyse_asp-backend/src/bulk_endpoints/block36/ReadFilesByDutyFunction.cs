...
// Returns metadata for files where a linked to a given duty function.
[Route("api/files/duty-function")]
[ApiController]
public class ReadFilesByDutyFunction : BaseStoredProcedureController
{
    public ReadFilesByDutyFunction(StoredProcedureService storedProcedureService, ILogger<ReadFilesByDutyFunction> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? functionId = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading files by duty function",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_by_duty_function", parameters);
            },
            result =>
            {
