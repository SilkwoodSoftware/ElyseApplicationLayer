...
[Route("api/files/date/before")]
[ApiController]
public class ReadFilesDateBefore : BaseStoredProcedureController
{
    public ReadFilesDateBefore(StoredProcedureService storedProcedureService, ILogger<ReadFilesDateBefore> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? fileDateNameId = null, [FromQuery] string dateValue = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            ...
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_date_before", parameters);
            },
            result =>
            {
