...
[Route("api/files/date/between")]
[ApiController]
public class ReadFilesDateBetween : BaseStoredProcedureController
{
    public ReadFilesDateBetween(StoredProcedureService storedProcedureService, ILogger<ReadFilesDateBetween> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] long? fileDateNameId = null, [FromQuery] string earlierDate = null, [FromQuery] string laterDate = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading files date between",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_date_between", parameters);
            },
            result =>
            {
