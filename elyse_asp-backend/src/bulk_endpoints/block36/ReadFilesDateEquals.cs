...
// Returns metadata for files where a date record is equal to a given date.
// Applies a filter group.
[Route("api/files/date/equals")]
[ApiController]
public class ReadFilesDateEquals : BaseStoredProcedureController
{
    public ReadFilesDateEquals(StoredProcedureService storedProcedureService, ILogger<ReadFilesDateEquals> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? fileDateNameId = null, [FromQuery] string dateValue = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            ...
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_date_equals", parameters);
            },
            result =>
            {
