...
[Route("api/files/integer/equals")]
[ApiController]
public class ReadFilesIntegerEquals : BaseStoredProcedureController
{
    public ReadFilesIntegerEquals(StoredProcedureService storedProcedureService, ILogger<ReadFilesIntegerEquals> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] long? fileIntNameId = null, [FromQuery] long? integerValue = null, [FromQuery] long? filterGroupId = null, [FromQuery] long? formId = null)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading files integer equals",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_int_equals", parameters);
            },
            result =>
            {
