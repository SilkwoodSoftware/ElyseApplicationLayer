...
[Route("api/files/multi-select/list")]
[ApiController]
public class ReadFilesByMultiSelectList : BaseStoredProcedureController
{
    public ReadFilesByMultiSelectList(StoredProcedureService storedProcedureService, ILogger<ReadFilesByMultiSelectList> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] ReadFilesByMultiSelectListRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading files by multi-select list",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_by_ms_list", parameters);
            },
            result =>
            {
...
public class ReadFilesByMultiSelectListRequest
{
