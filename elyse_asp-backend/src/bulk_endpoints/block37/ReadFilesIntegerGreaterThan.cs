...
[Route("api/files/integer/greater-than")]
[ApiController]
public class ReadFilesIntegerGreaterThan : BaseStoredProcedureController
{
    public ReadFilesIntegerGreaterThan(StoredProcedureService storedProcedureService, ILogger<ReadFilesIntegerGreaterThan> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] ReadFilesIntegerGreaterThanRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading files integer greater than",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_int_greater_than", parameters);
            },
            result =>
            {
...
public class ReadFilesIntegerGreaterThanRequest
{
