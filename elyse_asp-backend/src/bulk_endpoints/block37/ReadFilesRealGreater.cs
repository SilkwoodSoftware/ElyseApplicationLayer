...
[Route("api/files/real/greater")]
[ApiController]
public class ReadFilesRealGreater : BaseStoredProcedureController
{
    public ReadFilesRealGreater(StoredProcedureService storedProcedureService, ILogger<ReadFilesRealGreater> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> Read([FromQuery] ReadFilesRealGreaterRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "reading files real greater",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_real_greater", parameters);
            },
            result =>
            {
...
public class ReadFilesRealGreaterRequest
{
