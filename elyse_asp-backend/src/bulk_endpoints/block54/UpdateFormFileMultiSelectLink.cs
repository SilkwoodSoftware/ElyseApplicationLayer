...
// Updates a form to file mult-select field link.
[Route("api/form/file/multi-select/link")]
[ApiController]
public class UpdateFormFileMultiSelectLink : BaseStoredProcedureController
{
    public UpdateFormFileMultiSelectLink(StoredProcedureService storedProcedureService, ILogger<UpdateFormFileMultiSelectLink> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpPost("update")]
    public async Task<IActionResult> Update([FromBody] UpdateFormFileMultiSelectLinkRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "updating form file multi-select link",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("controlling.usp_UPD_form_file_ms_link", parameters);
            },
            result =>
            {
...
public class UpdateFormFileMultiSelectLinkRequest
{
