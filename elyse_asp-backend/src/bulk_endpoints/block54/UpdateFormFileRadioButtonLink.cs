...
// Updates a form to file radio button field link.
[Route("api/form/file/radio-button/link")]
[ApiController]
public class UpdateFormFileRadioButtonLink : BaseStoredProcedureController
{
    public UpdateFormFileRadioButtonLink(StoredProcedureService storedProcedureService, ILogger<UpdateFormFileRadioButtonLink> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpPost("update")]
    public async Task<IActionResult> Update([FromBody] UpdateFormFileRadioButtonLinkRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "updating form file radio button link",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("controlling.usp_UPD_form_file_radiob_link", parameters);
            },
            result =>
            {
...
public class UpdateFormFileRadioButtonLinkRequest
{
