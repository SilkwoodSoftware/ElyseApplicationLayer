...
// Inserts a form to document duty function list link.
[Route("api/form/document/duty-function/list/link")]
[ApiController]
public class InsertFormDocFunctionListLinks : BaseStoredProcedureController
{
    public InsertFormDocFunctionListLinks(StoredProcedureService storedProcedureService, ILogger<InsertFormDocFunctionListLinks> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpPost("create")]
    public async Task<IActionResult> Create([FromBody] InsertFormDocFunctionListLinksRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "creating form document function list links",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("controlling.usp_INS_fm_doc_funct_lst_links", parameters);
            },
            result =>
            {
...
public class InsertFormDocFunctionListLinksRequest
{
