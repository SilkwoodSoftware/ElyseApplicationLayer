...
// Inserts a form to document common object radio button link.
[Route("api/form/doc/common-object/radio-button/link")]
[ApiController]
public class InsertFormToDocCommonObjectRadioButtonLink : BaseStoredProcedureController
{
    public InsertFormToDocCommonObjectRadioButtonLink(StoredProcedureService storedProcedureService, ILogger<InsertFormToDocCommonObjectRadioButtonLink> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpPost("create")]
    public async Task<IActionResult> Create([FromBody] InsertFormToDocCommonObjectRadioButtonLinkRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "creating form to document common object radio button link",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("controlling.usp_INS_fm_dc_c_ob_rb_lnk", parameters);
            },
            result =>
            {
...
public class InsertFormToDocCommonObjectRadioButtonLinkRequest
{
