...
// Updates a link between a form and a file free text field.
[Route("api/form/file/free-text/link")]
[ApiController]
public class UpdateFormFileFreeTextLink : BaseStoredProcedureController
{
    public UpdateFormFileFreeTextLink(StoredProcedureService storedProcedureService, ILogger<UpdateFormFileFreeTextLink> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpPost("update")]
    public async Task<IActionResult> Update([FromBody] UpdateFormFileFreeTextLinkRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "updating form file free text link",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("controlling.usp_UPD_form_file_free_txt_lnk", parameters);
            },
            result =>
            {
...
public class UpdateFormFileFreeTextLinkRequest
{
