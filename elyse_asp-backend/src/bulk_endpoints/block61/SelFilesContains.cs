...
[ApiController]
public class SelFilesContains : BaseStoredProcedureController
{
    public SelFilesContains(StoredProcedureService storedProcedureService, ILogger<SelFilesContains> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> GetFilesContains([FromQuery] string containsString, [FromQuery] long? filterGroupId, [FromQuery] long? formId)
    {
