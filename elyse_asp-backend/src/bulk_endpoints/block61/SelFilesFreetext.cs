...
[ApiController]
public class SelFilesFreetext : BaseStoredProcedureController
{
    public SelFilesFreetext(StoredProcedureService storedProcedureService, ILogger<SelFilesFreetext> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> GetFilesFreetext([FromQuery] string containsString, [FromQuery] long? filterGroupId, [FromQuery] long? formId)
    {
