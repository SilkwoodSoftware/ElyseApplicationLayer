...
[ApiController]
public class SelFilesFreetexttable : BaseStoredProcedureController
{
    public SelFilesFreetexttable(StoredProcedureService storedProcedureService, ILogger<SelFilesFreetexttable> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read")]
    public async Task<IActionResult> GetFilesFreetexttable([FromQuery] string containsString, [FromQuery] long? filterGroupId, [FromQuery] long? formId)
    {
