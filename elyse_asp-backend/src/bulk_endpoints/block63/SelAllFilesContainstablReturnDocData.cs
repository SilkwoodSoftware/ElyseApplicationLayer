...
[ApiController]
public class SelAllFilesContainstablWithDocs : BaseStoredProcedureController
{
    public SelAllFilesContainstablWithDocs(StoredProcedureService storedProcedureService, ILogger<SelAllFilesContainstabl> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpGet("read-with-docs")]
    public async Task<IActionResult> GetAllFilesContainstablWithDocs([FromQuery] string containsString,  [FromQuery] long? formId)
    {
