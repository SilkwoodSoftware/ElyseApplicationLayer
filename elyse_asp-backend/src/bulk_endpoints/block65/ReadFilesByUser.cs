...
[Route("api/files/user")]
[ApiController]
public class ReadFilesByUser : BaseStoredProcedureController
{
    public ReadFilesByUser(StoredProcedureService storedProcedureService, ILogger<ReadFilesByUser> logger)
    ...
    public async Task<IActionResult> Read([FromQuery] long? userId, [FromQuery] long? filterGroupId, [FromQuery] long? formId)
    {
        return await ExecuteWithErrorHandlingAsync(
            ...
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("reading.usp_SEL_files_by_user", parameters);
            },
            result =>
            {
