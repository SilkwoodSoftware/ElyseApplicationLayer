...
// Inserts a form to file free text field link.
[Route("api/form/file/free-text/link")]
[ApiController]
public class InsertFormFileFreeTextLink : BaseStoredProcedureController
{
    public InsertFormFileFreeTextLink(StoredProcedureService storedProcedureService, ILogger<InsertFormFileFreeTextLink> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpPost("create")]
    public async Task<IActionResult> Create([FromBody] InsertFormFileFreeTextLinkRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "creating form file free text link",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("controlling.usp_INS_form_file_free_txt_lnk", parameters);
            },
            result =>
            {
...
public class InsertFormFileFreeTextLinkRequest
{
