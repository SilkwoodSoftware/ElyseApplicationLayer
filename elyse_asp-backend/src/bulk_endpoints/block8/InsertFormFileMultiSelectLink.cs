...
// Inserts a form to file multi select list link.
[Route("api/form/file/multi-select/link")]
[ApiController]
public class InsertFormFileMultiSelectLink : BaseStoredProcedureController
{
    public InsertFormFileMultiSelectLink(StoredProcedureService storedProcedureService, ILogger<InsertFormFileMultiSelectLink> logger)
        : base(storedProcedureService, logger, null)
    {
    }

    [HttpPost("create")]
    public async Task<IActionResult> Create([FromBody] InsertFormFileMultiSelectLinkRequest request)
    {
        return await ExecuteWithErrorHandlingAsync(
            "creating form file multi-select link",
            async () =>
            {
                ...
                return await _storedProcedureService.ExecuteStoredProcedureAsync("controlling.usp_INS_form_file_ms_link", parameters);
            },
            result =>
            {
...
public class InsertFormFileMultiSelectLinkRequest
{
